            ...
            <div className="form my-3">
                <form>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea type="text" className="form-control" id="description" name='description' aria-describedby="description" value={note.description}  rows={5} onChange={onChange} />
                    </div>
                    <div className="mb-3">
